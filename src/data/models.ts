...
export const GEMINI_MODELS: ModelCapabilityInfo[] = [
  ...
  },
  {
    ...
    shortDescription: 'Latest Flash model — faster and more efficient than 3.7.',
    longDescription: 'Latest Flash generation with improved speed and efficiency over 3.7 Flash.',
    family: 'flash',
    categoryGroup: 'Current',
    status: 'stable',
    available: true,
