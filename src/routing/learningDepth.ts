...
export function learningDepthInstruction(toolId:string):string {
 ...
 'Legacy task dependencies (not mandatory user questions): '+contract.required_inputs+'. Use the per-skill input contract to distinguish conversation context, optional personal details and source evidence. Never ask for internal IDs. Do not demand every input before useful general teaching.',
