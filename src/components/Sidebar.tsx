      ...
      <div className="w-72 bg-slate-50 border-r border-slate-200 flex flex-col h-full">
        ...
        >
          <div className="flex items-center justify-between mb-1">
            <span className="text-[11px] font-semibold uppercase text-slate-600" title="Overall consumption across all conversations stored in the database.">Overall Telemetry</span>
            <button
              onClick={(e) => {
                e.stopPropagation();
                resetSessionStats();
