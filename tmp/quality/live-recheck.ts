...
const results:any[]=[];
for(const [id,message] of cases.filter(([id])=>id!=='output-limit')){
 ...
 results.push(result);fs.writeFileSync('../outputs/Learning-Quality-Final-Checks.json',JSON.stringify(results,null,2));
